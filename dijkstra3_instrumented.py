...
def dijsktra3():
    ...
    ##REVIEW ALL INSTRUMENTATION / ABSTRACTION ASSUMPTIONS

    #We need to add another instrumentation axiom that is quite subtle.
    #that makes reduction of b in case 10 go through.
    #Everything seems to work on its own but when I combine things it works but I think it might be buggy.
    ...
    #The hinting is not optimal - so it will be quite complicated, but that will be improved hopefully.
